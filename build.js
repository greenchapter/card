...
const data = {
  ...
  github: chalk.gray('https://github.com/') + chalk.white('greenchapter'),
  linkedin: chalk.gray('https://linkedin.com/in/') + chalk.blue('greenchapter'),
  web: chalk.green('https://greenchapter.de'),
  npx: chalk.red('npx') + ' ' + chalk.red('greenchapter'),
